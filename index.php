        ...
        <section class="ftr__product__area ptb--100">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xs-12">
                        <div class="section__title--2 text-center">
                            <h2 class="title__line">For Testing</h2>
                            <br>
                            <form id="contact-form" action="#" method="post">
                                <div class="single-contact-form">
                                    <div class="contact-box name">
                                        <input type="text" id="pro_id" name="Pro_id" placeholder="Product Id*">
                                        <input type="email" id="Pro_name" name="Pro_name" placeholder="Product Name*">
										<input type="email" id="name" name="name" placeholder="Your Name*">
                                    </div>
                                </div>
